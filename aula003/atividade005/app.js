...
let nome = ['Bulbasaur','Ivysaur','Venusaur','Charmander','Charmeleon','Charizard',]
let fotos =[
...
document.getElementById("pokemon_nome").innerText = nome[indice]
...
document.getElementById("pokemon_nome").innerText = nome[pokemon_procurado -1]
document.getElementById("pokemon_numero").innerText = pokemon_procurado
}

function fnProximo(){
if(indice < nome.length -1){
indice = indice + 1
document.getElementById("pokemon_foto").src = fotos[indice]
document.getElementById("pokemon_nome").innertext = nome[indice]
document.getElementById("pokemon_numero").innertext = indice + 1
